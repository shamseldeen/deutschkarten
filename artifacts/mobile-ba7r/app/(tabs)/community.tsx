      ...
      >
        ...
        {loading && !stats ? (
          ...
          <View style={styles.statsGrid}>
            <StatCard icon="📚" value={stats.totalCards} label="Flashcards" color={colors.primary} />
            <StatCard icon="👥" value={stats.members} label="Members" color="#3b82f6" />
            <StatCard icon="🌍" value={stats.languages} label="Languages" color="#22c55e" />
            <StatCard icon="✨" value={stats.contributors} label="Contributors" color="#f59e0b" />
          </View>
        ) : null}
        ...
        <View style={[styles.board, { backgroundColor: colors.card, borderColor: colors.border }]}>
          ...
          {/* Legal note */}
          <Text style={[styles.legalNote, { color: colors.mutedForeground, backgroundColor: colors.muted + "40" }]}>
