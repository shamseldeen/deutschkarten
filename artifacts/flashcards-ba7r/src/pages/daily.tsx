...
export default function Daily() {
  ...
  const handleProgress = (id: number, known: boolean) => {
    ...
    if (cards && currentIndex < cards.length - 1) {
      ...
      setIsDone(true);
      queryClient.invalidateQueries({ queryKey: getGetDailyFlashcardsQueryKey() });
    }
  };
    ...
    return (
      <Layout>
        <div className="flex flex-col items-center justify-center min-h-[60vh] text-center max-w-md mx-auto">
          ...
          <h2 className="text-3xl font-black font-serif mb-2">All Caught Up!</h2>
          <p className="text-muted-foreground mb-8">You don't have any cards due for review today. Great job staying on top of your learning!</p>
     ...
     return (
      <Layout>
        <div className="flex flex-col items-center justify-center min-h-[60vh] text-center max-w-md mx-auto animate-in fade-in zoom-in">
          ...
          <p className="text-muted-foreground mb-8">You've completed your daily review set. Your brain is getting stronger every day.</p>
          <Link href="/">
    ...
    <Layout>
      <div className="flex flex-col items-center max-w-md mx-auto w-full">
        <div className="w-full flex justify-between items-center mb-6 px-2">
          <span className="text-sm font-bold text-muted-foreground uppercase tracking-widest">Daily Review</span>
