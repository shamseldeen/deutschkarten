...
export function GuestProgressBanner({ variant = "soft", sessionXp = 0 }: { variant?: BannerVariant; sessionXp?: number }) {
  ...
  return (
    <div className="w-full bg-gradient-to-r from-amber-50 to-yellow-50 dark:from-amber-950/30 dark:to-yellow-950/30 border border-amber-200 dark:border-amber-800 rounded-xl p-3 flex items-center gap-3">
