      ...
      <div className="relative p-6 md:p-8 grid md:grid-cols-[1fr_auto] gap-6 items-center">
        ...
        <div className="hidden md:flex items-center justify-center">
          <div className="relative w-32 h-32">
            <div className="absolute inset-0 rounded-full bg-gradient-to-br from-amber-300 to-amber-500 shadow-xl shadow-primary/20" />
            <div className="absolute inset-3 rounded-full bg-gradient-to-br from-amber-200 to-amber-400" />
            {Array.from({ length: 12 }).map((_, i) => (
              <div
                key={i}
                className="absolute top-1/2 left-1/2 w-1.5 h-6 bg-amber-400 rounded-full origin-bottom"
                style={{
