  ...
  return (
    ...
    >
      ...
      <Text style={[s.subtitle, { color: colors.mutedForeground }]}>
        A clear path from absolute beginner to advanced. Each CEFR level shows
        what you should be able to do, the grammar to master, and a realistic
        vocab goal.
      </Text>
            ...
            <View style={s.cardBody}>
              <View style={s.cardHeaderRow}>
                <View style={{ flex: 1 }}>
                  <View style={s.row}>
                    <View style={[s.levelBadge, { borderColor: color }]}>
                      <Text style={[s.levelBadgeText, { color }]}>
                        {lv.level}
                      </Text>
                    </View>
                ...
                <View style={{ alignItems: "flex-end" }}>
                  <Text style={[s.vocab, { color }]}>
                    {lv.vocabGoal.toLocaleString()}
                  </Text>
                  <Text
                    style={[s.vocabLabel, { color: colors.mutedForeground }]}
                  >
                    WORDS
                  </Text>
                  <Text
      ...
      <Text style={[s.h2, { color: colors.foreground, marginTop: 24 }]}>
      ...
      {STUDY_HABITS.map((h) => (
        ...
        >
          <View
            style={[s.habitIcon, { backgroundColor: colors.primary + "15" }]}
          >
            <Feather name={h.icon} size={18} color={colors.primary} />
          </View>
          <View style={{ flex: 1 }}>
            <Text style={[s.habitTitle, { color: colors.foreground }]}>
              {h.title}
            </Text>
            <Text style={[s.habitDesc, { color: colors.mutedForeground }]}>
              {h.desc}
            </Text>
          </View>
        </View>
      ...
      >
        <Text style={[s.ctaTitle, { color: colors.foreground }]}>
          Ready to start?
        </Text>
        <Text style={[s.ctaDesc, { color: colors.mutedForeground }]}>
          Pick today&rsquo;s practice or take a placement quiz to see where you
          stand.
        </Text>
        <View
          style={{
